...
void write_superblock(int fd) {
	...
	superblock.s_state = EXT2_FS_VALID; /* File system is clean */
...
void write_inode_table(int fd) {
	...
	root_inode.i_gid = 0;
	root_inode.i_links_count = 3; //up one from lost and found
	...
	hello_world_inode.i_links_count = 1; //file
